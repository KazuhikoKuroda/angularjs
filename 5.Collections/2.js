angular.module('mainModule', [])
	.controller('mainController', function($scope, $filter, dateFilter) {
		...
		$scope.formatDate1 = function(dateData, format) {
			return $filter("date")(dateData, format);
		};

		$scope.formatDate2 = function(dateData, format) {
			return dateFilter(dateData, format);
		}
	})
